...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Trigger
    ref={ref}
    className={cn("leading-none tracking-tight focus:outline-none", className)}
    {...props}
  />
));
...
const drawerContentVariants = cva(
  "fixed z-50 flex h-auto flex-col border bg-background w-[280px]",
  {
    variants: {
      direction: {
        right:
          "ml-24 right-0 rounded-l-[10px] inset-y-0 w-full max-w-[300px] focus:outline-none",
